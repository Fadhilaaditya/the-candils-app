...
const menuItems: MenuItem[] = [
  { 
    name: 'Dashboard', 
    routeName: 'admin-dashboard-main', 
  ...
  { 
    name: 'Produk', 
    routeName: 'admin-products-kelola',
    path: '/admin/dashboard/products',
    exactPath: '/admin/dashboard/products/review', // Exclude review dari produk
  ...
  { 
    name: 'Review', 
    routeName: 'admin-review', 
    path: '/admin/dashboard/products/review', 
...
const isActive = (item: MenuItem) => {
  ...
  if (item.path === '/admin/dashboard') {
    return route.name === 'admin-dashboard-main'
  }
