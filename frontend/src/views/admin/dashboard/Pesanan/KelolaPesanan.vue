<template>
  <div class="p-6 bg-gray-50 min-h-screen">
    ...
    <!-- Modal Input Pesanan Offline (BARU) -->
...
import PesananAddReportModal from './_components/AddPesananViewModal.vue' // IMPOR BARU
import {
getAllPesanan,
getAllLokasi,
getPesananById,
...
const showAddModal = ref(false) // STATE BARU UNTUK MODAL ADD REPORT
...
const handleOrderReported = () => { // FUNGSI BARU UNTUK REPORTED ORDER
  showAddModal.value = false
  loadData() // Muat ulang data setelah pesanan baru dilaporkan
}
