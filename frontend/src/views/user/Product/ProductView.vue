<template>
  <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    ...
    <!-- Error State -->
    <div v-else-if="errorMessage" class="text-center py-20 bg-red-50 rounded-lg max-w-2xl mx-auto p-6">
       ...
       <button @click="fetchProductsData" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors duration-200">
         Coba Lagi
       </button>
    </div>
